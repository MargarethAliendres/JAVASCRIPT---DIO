...
public class ProjectDialogScreen extends javax.swing.JDialog {
            ProjectController controller;   // variavel geral de controller//
    /**
    ...
    public ProjectDialogScreen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controller = new ProjectController();    // objeto da controller//
    ...
    private void initComponents() {
        ...
        jTextField1Nome.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        jTextArea1Descricao.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        project.setNome(jTextField1Nome.getText());      // pego o endereço que esta na arvore o qual renomeei
        project.setDescricao(jTextArea1Descricao.getText());
                        
        controller.save  (project);    // salva no banco de dados
        
        JOptionPane.showInternalMessageDialog(rootPane, "Projeto salvo com suecesso");
